...
public final class NeoSteerControllerFactoryBuilder {
    ...
    public class FactoryImplementation<T> implements SteerControllerFactory<ControllerImplementation, NeoSteerConfiguration<T>> {
        ...
        public ControllerImplementation create(NeoSteerConfiguration<T> steerConfiguration, ModuleConfiguration moduleConfiguration) {
            ...
            SparkFlex motor = new SparkFlex(steerConfiguration.getMotorPort(), SparkLowLevel.MotorType.kBrushless);
            ...
            config
                .inverted(!moduleConfiguration.isSteerInverted())
                .idleMode(IdleMode.kBrake);
            config.encoder
                .positionConversionFactor(2.0 * Math.PI * moduleConfiguration.getSteerReduction())
    ...
    public static class ControllerImplementation implements SteerController {
        ...
        public ControllerImplementation(SparkFlex motor, AbsoluteEncoder absoluteEncoder) {
            this.motor = motor;
        ...
        public void setReferenceAngle(double referenceAngleRadians) {
            ...
            controller.setReference(adjustedReferenceAngleRadians, SparkFlex.ControlType.kPosition);
        }
